...
" FIXME: Fazer atributos nao serem marcados!
if exists("python_highlight_builtins") && python_highlight_builtins != 0
  let python_highlight_builtints_func = 1
  let python_highlight_builtints_type = 1
  let python_highlight_builtints_objs = 1
endif

if exists("python_highlight_builtins_objs") && python_highlight_builtins_objs != 0
  " Builtin functions, types and objects
  syn keyword pythonBuiltinObj	True False Ellipsis None NotImplemented
  syn keyword pythonBuiltinObj	__debug__ __doc__ __file__ __name__ __package__
endif

if exists("python_highlight_builtins_type") && python_highlight_builtins_type != 0
  syn keyword pythonBuiltinFunc int list tuple str bool dict set bytes basestring
  syn keyword pythonBuiltinFunc buffer
endif

if exists("python_highlight_builtins_func") && python_highlight_builtins_func != 0
  syn keyword pythonBuiltinFunc	__import__ abs all any apply
  syn keyword pythonBuiltinFunc	bin bytearray callable
  ...
  syn keyword pythonBuiltinFunc	issubclass iter len locals long map max
